...
var NODE_DATA = {
  ...
  doing: { emoji:'', tag:'DRILL LIBRARY', title:'Do', role:'Train one physical guitar skill at a time.', desc:'Choose a drill for rhythm, picking, fretting, coordination, strength, or control.', cta:'Choose a drill \u2192', enter:true, action:'doing', icon:'images/map-nodes-generated-v2-normalized/doing.png' },
