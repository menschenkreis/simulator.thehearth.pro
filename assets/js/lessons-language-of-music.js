      ...
      choices: [
        ...
        },
        {
          ...
          reexplain: [
            ...
            { char: TeachingCHAR.lightbulb, text: '<p>Between most of those natural notes, there\'s a sharp. A, A#, B, C, C#, D, D#, E, F, F#, G, G# — that\'s 12 total. The 7 natural notes plus 5 sharps give you the full alphabet.</p>' },
      ...
      choices: [
        ...
        },
        {
          ...
          reexplain: [
            ...
            { char: TeachingCHAR.lightbulb, text: '<p>The short jumps — only one half step — are <strong>B to C</strong> and <strong>E to F</strong>. No sharp between them. One fret on the guitar, not two. These two pairs are special. Memorise them.</p>' },
      ...
      choices: [
        ...
        },
        {
          ...
          reexplain: [
            ...
            { char: TeachingCHAR.lightbulb, text: '<p>A whole step = <strong>two</strong> half steps = two frets. Think of it like this: a half step is one stair. A whole step is two stairs.</p>' },
      ...
      choices: [
        ...
        },
        {
          ...
          reexplain: [
            ...
            { char: TeachingCHAR.lightbulb, text: '<p>The root is the <em>home note</em> — the note everything else is measured from. It\'s the first note of a scale, yes, but it\'s also the foundation of a chord, the key of a song, the centre of gravity for all the other notes.</p>' },
