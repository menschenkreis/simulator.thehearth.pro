...
(function(){
  ...
  window.showCreate=function(){
    ...
    el.innerHTML=sceneStart('sf-create','The Cauldron','Create begins with one object: the cauldron. Ingredients are constraints. The song seed appears after you throw something in.','Do not judge the spark too early. Add one ingredient, catch what bubbles up, then shape it.','images/character-full/Sparks.png')+'<div class="sf-stage"><div class="sf-create-stage">'+buttons(left)+'<div class="sf-cauldron"><div class="sf-bubble">'+esc(c.prompt||'Add one ingredient.')+'</div><div class="sf-pot">◠</div><div class="sf-flame">▲ ▲ ▲</div></div>'+buttons(right)+'</div></div><div id="sf-create-work" class="sf-drawer">'+createDrawer(c)+'</div></div></div>';
  };
  ...
  window.showMastery=function(){
    ...
    el.innerHTML=sceneStart('sf-phoenix','Mastery · Phoenix Rising','Mastery is not just proof. Proof is the floor. Mastery is going beyond: studying those who crossed the boundary, transforming skill into voice, and rising into a new form.','You do not master by finishing. You master by returning, transforming, and going beyond what the map first showed you.','images/character-full/Sparks.png')+'<div class="sf-stage">'+phoenix+'</div><div id="sf-drawer" class="sf-drawer">Choose a phoenix seal: hear beyond, find your voice, transform skill, or transmit the fire.</div></div></div>';
  };
