...
const DOING = {
  ...
  categories: [
    ...
    },
    {
      ...
      drills: [
        { id:'chrom-1', title:'1-2-3-4 Chromatic Exercise', difficulty:1, bpm:'60-120', duration:'5 min', source:'Cary White', style:'rock', body:'<p>Index=1, Middle=2, Ring=3, Pinky=4. All 6 strings, shift up the neck. Fingers stay close to fretboard.</p>', video:'https://www.youtube.com/watch?v=vPJjIMivs7U' },
        { id:'spider-1', title:'Spider Exercise — Cross String', difficulty:2, bpm:'40-80', duration:'8 min', source:'Exercises For Dummies', style:'rock', body:'<p>Isolates each finger. 1-3 on one string, 2-4 on next. Fingers move independently.</p>', video:'https://www.youtube.com/watch?v=GyGkASBCbWw' },
        { id:'barre-1', title:'Barre Chord Strength Builder', difficulty:2, bpm:'—', duration:'10 min', source:'Exercises For Dummies', style:'rock', body:'<p>Barre at fret 5. Squeeze 5 sec, release 5 sec × 10. Build endurance without strain. Thumb behind neck, arm pulling back.</p>', video:'https://www.youtube.com/watch?v=PI4Pce2HonM' },
        ...
        { id:'trill-1', title:'Trill Exercise — Hammer/Pull Endurance', difficulty:2, bpm:'—', duration:'5 min', source:'Stetina — Speed Mechanics', style:'metal', body:'<p>Hammer-on/pull-off between two fingers. 60 seconds each pair: 1-2, 1-3, 1-4, 2-3, 2-4, 3-4. Count the reps. Build stamina.</p>', video:'https://www.youtube.com/watch?v=Oihj1LENZFA' },
        { id:'legato-1', title:'Legato — Hammer-ons & Pull-offs', difficulty:2, bpm:'60-100', duration:'8 min', source:'Stetina — Speed Mechanics', style:'rock', body:'<p>Pick fret 5, hammer to 7, pull off. Same volume as picked note. Legato = smooth and connected.</p>', video:'https://www.youtube.com/watch?v=dYaeIXXyy1Y' },
        { id:'legato-2', title:'Legato — 3-Note-Per-String Runs', difficulty:3, bpm:'50-90', duration:'10 min', source:'Stetina — Speed Mechanics', style:'metal', body:'<p>3NPS legato runs. Pick first note of each string, hammer the other two. The shredder\', video:'https://www.youtube.com/watch?v=ZORL0JBBscY's secret.</p>' },
        { id:'classical-1', title:'Classical Left Hand — PIMA Position', difficulty:1, bpm:'—', duration:'8 min', source:'Parkening Vol 1', style:'classical', body:'<p>Thumb behind neck (not over), fingers curved, fingertips only. Classical position is the foundation of clean fretting.</p>', video:'https://www.youtube.com/watch?v=QXnnOqxGGNQ' },
        { id:'stretch-1', title:'Finger Stretch — 1-2-4 Spread', difficulty:1, bpm:'60-80', duration:'5 min', source:'Exercises For Dummies', style:'rock', body:'<p>Index on fret 1, middle on fret 2, pinky on fret 4. Skip fret 3 intentionally. Builds pinky reach. Do all strings.</p>', video:'https://www.youtube.com/watch?v=geajGShIxpI' },
        { id:'vibrato-1', title:'Vibrato — Bending in Place', difficulty:2, bpm:'—', duration:'5 min', source:'Ganapes — Blues You Can Use', style:'blues', body:'<p>Bend the string slightly and oscillate. The secret is control — slow and wide for blues, fast and narrow for classical. Practice on one note for 2 minutes.</p>', video:'https://www.youtube.com/watch?v=TrYWfqO2qmc' }
      ]
    },
    {
      id: 'rhythm',
      ...
      drills: [
        { id:'16th-1', title:'16th Note Subdivision', difficulty:1, bpm:'60-100', duration:'5 min', source:'Berklee Phase 2', style:'rock', body:'<p>Count: 1-e-&-a. Play one note per subdivision. Accent beat 1, then "&"s, then "a"s.</p>', video:'https://www.youtube.com/watch?v=86voMId16iU' },
        { id:'funk-1', title:'Scratch Muting — Funk Grid', difficulty:1, bpm:'70-110', duration:'8 min', source:'Bolton — Funk Guitar', style:'funk', body:'<p>Left hand lightly across strings. Pick = percussive "chk". 16th-note scratch pattern, accent 1 and & of 2.</p>', video:'https://www.youtube.com/watch?v=r6JKyahHvGg' },
        ...
        { id:'strum-1', title:'Basic Strumming — D DU UDU', difficulty:1, bpm:'60-100', duration:'5 min', source:'General knowledge', style:'rock', body:'<p>The universal strum pattern. Down, Down-Up, Up-Down-Up. Works for thousands of songs. G-C-D-Em loop.</p>', video:'https://www.youtube.com/watch?v=MbSY1Pfbz-k' },
        ...
        { id:'reggae-1', title:'Reggae Skank — Offbeat Muting', difficulty:2, bpm:'70-100', duration:'5 min', source:'General knowledge', style:'reggae', body:'<p>Play chords ONLY on beats 2 and 4. Mute on 1 and 3. The guitar becomes a percussion instrument.</p>', video:'https://www.youtube.com/watch?v=h3-q8v3xbxU' },
        { id:'metronome-1', title:'Metronome Displacement', difficulty:2, bpm:'60-80', duration:'8 min', source:'Jamie Andreas', style:'rock', body:'<p>Set metronome to click on beats 2 and 4 only (not 1 and 3). Forces you to internalize the pulse. Advanced: metronome clicks on the "and" of each beat.</p>', video:'https://www.youtube.com/watch?v=ATA76Jf18qI' },
    ...
    },
    {
      ...
      drills: [
        { id:'pent-1', title:'Minor Pentatonic — Box 1', difficulty:1, bpm:'60-100', duration:'5 min', source:'Exercises For Dummies', style:'blues', body:'<p>A minor pentatonic at fret 5. The rock/blues staple. Up and down, one note per beat.</p>', video:'https://www.youtube.com/watch?v=H6yh8H6kNno' },
        { id:'pent-2', title:'Minor Pentatonic — All 5 Boxes', difficulty:2, bpm:'60-80', duration:'12 min', source:'Exercises For Dummies', style:'blues', body:'<p>5 moveable shapes covering the entire neck. Learn all 5 = fretboard freedom in any minor key.</p>', video:'https://www.youtube.com/watch?v=jVzYUUHRaRw' },
        { id:'major-1', title:'Major Scale — Position 1', difficulty:1, bpm:'50-80', duration:'5 min', source:'Guitar Aerobics (Tue)', style:'classical', body:'<p>C major at fret 8. The foundation of Western music. Slow, listen to the sound.</p>', video:'https://www.youtube.com/watch?v=T84Wiid_ZfE' },
        { id:'major-2', title:'Major Scale — 3 Notes Per String', difficulty:2, bpm:'50-80', duration:'10 min', source:'Stetina — Speed Mechanics', style:'metal', body:'<p>7 positions, 3 notes each string. The metal/rock scale pattern. Enables fast runs.</p>', video:'https://www.youtube.com/watch?v=pyUwHPWrQLo' },
        { id:'modes-1', title:'Modes — Dorian (C to C on white keys)', difficulty:2, bpm:'50-70', duration:'8 min', source:'Belkadi — Advanced Scales', style:'jazz', body:'<p>Play D Dorian = C major starting on D. Hear the minor-with-bright-6th sound. Santana\', video:'https://www.youtube.com/watch?v=dJfV7DsTThc's signature.</p>' },
        ...
        { id:'harm-min-1', title:'Harmonic Minor Scale', difficulty:2, bpm:'50-70', duration:'8 min', source:'Belkadi — Advanced Scales', style:'flamenco', body:'<p>Minor scale with raised 7th. The exotic, Middle Eastern, flamenco sound. Essential for classical and metal.</p>', video:'https://www.youtube.com/watch?v=rToM-6U8I-k' },
        ...
        { id:'blues-scale-1', title:'Blues Scale — Adding the b5', difficulty:1, bpm:'60-90', duration:'5 min', source:'Ganapes — Blues You Can Use', style:'blues', body:'<p>Minor pentatonic + b5 (the "blue note"). Adds the tension that makes blues sound like blues.</p>', video:'https://www.youtube.com/watch?v=jlgq0yamjuY' },
        { id:'minor-nat-1', title:'Natural Minor Scale — Full Neck', difficulty:2, bpm:'50-80', duration:'10 min', source:'Exercises For Dummies', style:'rock', body:'<p>The full Aeolian mode across all positions. Darker than pentatonic — every note matters. Connect all 7 positions up the neck.</p>', video:'https://www.youtube.com/watch?v=1Ag3110p0rg' },
        { id:'pent-3', title:'Major Pentatonic — Country & Pop', difficulty:1, bpm:'60-100', duration:'5 min', source:'Exercises For Dummies', style:'country', body:'<p>The happy cousin of minor pentatonic. Same 2-notes-per-string shapes, different root. Country, pop, and Southern rock staple.</p>', video:'https://www.youtube.com/watch?v=m_IiyJu60-c' },
    ...
    },
    {
      ...
      drills: [
        { id:'maj-arp', title:'Major Arpeggio — 3 Notes', difficulty:1, bpm:'60-90', duration:'5 min', source:'Guitar Aerobics (Thu)', style:'rock', body:'<p>Root-3rd-5th. C-E-G. Play each note individually, let ring. 2 octaves.</p>', video:'https://www.youtube.com/watch?v=fxpn2pf0zf8' },
        { id:'min-arp', title:'Minor Arpeggio — 3 Notes', difficulty:1, bpm:'60-90', duration:'5 min', source:'Guitar Aerobics (Thu)', style:'rock', body:'<p>Root-b3-5th. A-C-E. The sad version. Same shape, different interval.</p>', video:'https://www.youtube.com/watch?v=fxpn2pf0zf8' },
        { id:'dom7-arp', title:'Dominant 7th Arpeggio', difficulty:2, bpm:'50-80', duration:'8 min', source:'Exercises For Dummies', style:'blues', body:'<p>Root-3rd-5th-b7th. A-C#-E-G. The blues/funk sound. Tension wants to resolve.</p>', video:'https://www.youtube.com/watch?v=PpBN9hqBKnI' },
        ...
        { id:'sweep-arp', title:'Sweep Arpeggio — Major (5 strings)', difficulty:3, bpm:'40-60', duration:'10 min', source:'Stetina — Speed Mechanics', style:'metal', body:'<p>Full sweep across 5 strings. Pick drags down then up. Each note rings individually.</p>', video:'https://www.youtube.com/watch?v=3omOl5Cp4go' },
        { id:'classical-arp', title:'Classical Arpeggio Patterns — PIMA', difficulty:2, bpm:'60-80', duration:'8 min', source:'Parkening Vol 1', style:'classical', body:'<p>Right hand arpeggio patterns: P-I-M-A, P-I-M-A-M-I. The classical guitar tone engine.</p>', video:'https://www.youtube.com/watch?v=yT23Kn2SrqU' }
      ]
    },
    {
      id: 'speed',
      ...
      drills: [
        ...
        { id:'tap-1', title:'Tapping — Introduction', difficulty:3, bpm:'50-80', duration:'10 min', source:'Satriani — Guitar Secrets', style:'rock', body:'<p>Right hand taps high notes, pull-off chain. Pick→tap→pull-off→pull-off. Three notes, one pick stroke.</p>', video:'https://www.youtube.com/watch?v=y9LevTuFOGs' },
        { id:'tap-2', title:'Tapping — Arpeggio Patterns', difficulty:3, bpm:'40-70', duration:'12 min', source:'Satriani — Guitar Secrets', style:'metal', body:'<p>Tapped arpeggios across strings. Eddie Van Halen\', video:'https://www.youtube.com/watch?v=oO4rMkM5DD0's signature. Tap the 5th, pull to root, pull to 3rd.</p>' },
        { id:'speed-ramp', title:'Speed Ramp — Progressive BPM', difficulty:2, bpm:'60-140', duration:'10 min', source:'Guitar Aerobics', style:'metal', body:'<p>Start a pattern at 60 BPM. Play it clean 3 times. Bump to 65. Repeat. Find your ceiling. That\', video:'https://www.youtube.com/watch?v=w27TRX00woo's your current max. Practice 10 BPM below it.</p>' },
    ...
    },
    {
      ...
      drills: [
        ...
        { id:'slide-1', title:'Slide Guitar — Open D Basics', difficulty:2, bpm:'—', duration:'8 min', source:'Hamburger — Slide Basics', style:'slide', body:'<p>Tune to Open D (D-A-D-F#-A-D). Place slide on ring finger. Light touch, right over the fret. Let it sing.</p>', video:'https://www.youtube.com/watch?v=Yq5DCyGQXs4' },
        { id:'slide-2', title:'Slide Guitar — Standard Tuning', difficulty:2, bpm:'—', duration:'8 min', source:'Hamburger — Slide Basics', style:'slide', body:'<p>Slide in standard tuning. Target chord tones. Mute behind the slide with index finger.</p>', video:'https://www.youtube.com/watch?v=iomZmdFn6B0' },
        { id:'pima-1', title:'Classical Right Hand — PIMA Patterns', difficulty:1, bpm:'60-80', duration:'5 min', source:'Parkening Vol 1', style:'classical', body:'<p>P=thumb, I=index, M=middle, A=ring. Basic arpeggio: P-I-M-A-M-I. Classical guitar tone starts here.</p>', video:'https://www.youtube.com/watch?v=ael-nRUmMV8' },
        { id:'pima-2', title:'Classical — Rest Stroke vs Free Stroke', difficulty:1, bpm:'—', duration:'5 min', source:'Parkening Vol 1', style:'classical', body:'<p>Rest stroke: finger follows through to rest on next string. Loud, full tone. Free stroke: finger clears the string. Lighter, for arpeggios.</p>', video:'https://www.youtube.com/watch?v=wF7idTF2oZk' },
