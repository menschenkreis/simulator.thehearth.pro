...
(function(){
  ...
  function injectStyles(){
    ...
    style.textContent = `
      ...
      .journey-neck-level.mastery .journey-mastery-icon img{position:relative;z-index:6;width:60px;height:60px;object-fit:contain;filter:brightness(1.45) contrast(1.18) drop-shadow(0 0 5px rgba(255,255,232,.9)) drop-shadow(0 0 14px rgba(255,170,64,.72));pointer-events:none}
