...
(function(){
  ...
  function injectStyles(){
    ...
    style.textContent = `
      ...
      .journey-neck-level.mastery .journey-mastery-icon img{position:relative;left:2px;z-index:6;width:74px;height:74px;object-fit:contain;filter:brightness(1.55) contrast(1.2) drop-shadow(0 0 5px rgba(255,255,232,.95)) drop-shadow(0 0 16px rgba(255,170,64,.78));pointer-events:none}
