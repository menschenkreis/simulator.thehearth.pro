      ...
      choices: [
        ...
        },
        {
          ...
          reexplain: [
            ...
            { char: TeachingCHAR.encouraging, text: '<p>The three main sections are <strong>Headstock</strong> (top, with tuning pegs), <strong>Neck</strong> (long part, with fretboard and frets), and <strong>Body</strong> (the big part that amplifies the sound). Strings, frets, and sound hole are details within those sections.</p>' },
      ...
      choices: [
        ...
        },
        {
          ...
          reexplain: [
            ...
            { char: TeachingCHAR.encouraging, text: '<p>The guitar should rest on your leg, supported by your right arm\'s weight. Your left hand holds the neck gently — thumb behind, fingers curved. If you\'re gripping hard, your hand will tire in minutes and your playing will suffer.</p><p>Supported, not clamped. That\'s the rule.</p>' },
      ...
      choices: [
        ...
        },
        {
          ...
          reexplain: [
            ...
            { char: TeachingCHAR.encouraging, text: '<p>In a rest stroke, you push the string down and <em>keep going</em> until your thumb lands on the next string. Your thumb "rests" there. This gives a full, round, powerful sound. It\'s the most important right-hand technique to learn first.</p>' },
      ...
      choices: [
        ...
        },
        {
          ...
          reexplain: [
            ...
            { char: TeachingCHAR.encouraging, text: '<p>The real skill is consistency. Can you make 10 notes that all sound identical? Same volume, same tone, same duration? Speed comes later — much later. Right now, one clean note is enough.</p>' },
